...
do
	...
	do
		e=$((e+1))
		CUDA_VISIBLE_DEVICES=$i python /paperspace/apps/BindCraft/bindcraft.py --settings "./tgfbr2_${e}.json" --filters './default_filters.json' --advanced './hotspots5_4stage_multimer.json' &
	done
done
wait
