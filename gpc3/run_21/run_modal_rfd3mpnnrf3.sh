...
cat binder_sequences_strict.csv | nl -w 4 -n rz | sed 's/^/gpc3_rfd3_smb_h1_ac_/' >> orders_instance_gpc3_run_21_dec2025_strict.csv
cat binder_sequences_lenient.txt | nl -w 4 -n rz | sed 's/^/gpc3_rfd3_smb_h1_ac_/' >> orders_instance_gpc3_run_21_dec2025_lenient.csv
