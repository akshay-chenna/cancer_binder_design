...
awk -F , '{print $4}' out/boltzgen/${DATE}/combined/final_ranked_designs/final_designs_metrics_${BUDGET}.csv | sort -u | nl -w 4 -n rz | head -${BUDGET} | sed 's/^/pdl1_bg_mb_1_ac_/' > orders_instance_pdl1_run4_dec2025.csv
