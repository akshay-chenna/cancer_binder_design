...
inference.output_prefix=C4/C4 inference.input_pdb=af3_cd8ab_ecto_nosignalp_model_0_tidy.pdb \
...
potentials.guiding_potentials=[\"type:binder_ROG,weight:5,min_dist:5\"] potentials.guide_scale=2 potentials.guide_decay='quadratic'
